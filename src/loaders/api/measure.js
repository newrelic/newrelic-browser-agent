...
export function measure (name, options, agentRef, targetEntityGuid, timestamp = now()) {
  ...
  handle(prefix + MEASURE, [returnObj, name, targetEntityGuid], undefined, FEATURE_NAMES.genericEvents, agentRef.ee)
