...
export class ApiBase {
  ...
  */
   ...
   * @param {{start: number|PerformanceMark, end: number|PerformanceMark, duration: number, customAttributes: object}} [options] An object used to control the way the measure API operates
