...
let supported = testDriver.Matcher.withFeature("wrappableAddEventListener").and(
  notSafariWithSeleniumBug
);
...
testDriver.test(
  "capturing SPA interactions with zone.js",
  supported,
  function (t, browser, router) {
    ...
    let loadPromise = browser.safeGet(
      router.assetURL("spa/zonejs.html", { loader: "spa", init })
    );
