...
jil.browserTest(
  "addEventListener should target only the given event",
  function (t) {
    var ee = baseEE;
    ...
    t.equal(
      1,
      handlerCallCount,
      "expected only one handler call for click event"
    );
...
jil.browserTest(
  "addEventListener should not blow up with a null func",
  function (t) {
    wrapEvents(baseEE);
...
jil.browserTest(
  "addEventListener allows multiple subscribers to same event on same element",
  function (t) {
    wrapEvents(baseEE);
...
jil.browserTest(
  "addEventListener allows object with handleEvent property",
  function (t) {
    var ee = baseEE;
    ee.removeListener = removeListener;
    wrapEvents(baseEE);
...
jil.browserTest(
  "addEventListener allows for multiple event listeners with an object",
  function (t) {
    var ee = baseEE;
    ee.removeListener = removeListener;
    wrapEvents(baseEE);
...
jil.browserTest(
  "addEventListener allows object with handleEvent property that is mutated",
  function (t) {
    var ee = baseEE;
    ee.removeListener = removeListener;
    wrapEvents(baseEE);
...
jil.browserTest(
  "addEventListener allows object with handleEvent property that is originally null",
  function (t) {
    wrapEvents(baseEE);
...
jil.browserTest(
  "removeEventListener works with handleEvent property",
  function (t) {
    wrapEvents(baseEE);
...
jil.browserTest(
  "removeEventListener works when same callback is passed for different events",
  function (t) {
    wrapEvents(baseEE);
    ...
    t.equal(
      handlerCallCount,
      2,
      "should have seen handler calls for both events"
    );
    ...
    t.equal(
      handlerCallCount,
      3,
      "should have seen handler call for mouseup only"
    );
    ...
    t.equal(
      handlerCallCount,
      3,
      "should have seen handler calls for neither event"
    );
...
jil.browserTest(
  "removeEventListener works when same callback is passed for different elements",
  function (t) {
    wrapEvents(baseEE);
    ...
    t.equal(
      handlerCallCount,
      2,
      "should have seen handler calls for both elements"
    );
    ...
    t.equal(
      handlerCallCount,
      3,
      "should have seen handler calls for neither element"
    );
