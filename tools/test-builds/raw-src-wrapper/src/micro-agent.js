...
// Instantiate this at the top level of your component code and share the instance across your build
...
// later... somewhere in your component code you want to add a page action
myMicroAgent.addPageAction('test-page-action', { foo: 'bar' })
console.log('added page action')

// later... somewhere in your component code you want to capture an error
myMicroAgent.noticeError(new Error('test-error'), { foo: 'bar' })
console.log('noticed error')

// later... somewhere in your component code you want to log something to the log API
