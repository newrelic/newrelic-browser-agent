...
describe('gql.js', () => {
  describe('parseGQL', () => {
    ...
    test('Returns meta object when valid', () => {
      ...
      expect(querymeta.framework).toEqual('GraphQL')
      ...
      expect(anonmeta.framework).toEqual('GraphQL')
      ...
      expect(mutationmeta.framework).toEqual('GraphQL')
    })
  })
  ...
  describe('parseBatchGQL', () => {
    ...
    test('Returns meta object when valid', () => {
      ...
      expect(batchmeta.framework).toEqual('GraphQL')
    })
  })
})
