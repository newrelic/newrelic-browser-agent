...
export class AggregateBase extends FeatureBase {
  ...
  makeHarvestPayload (shouldRetryOnFail = false, target) {
    ...
    // TODO CONVERT THIS TO A WARNING/IERR
    ...
    return returnedDataArr.map(({ targetApp, data }) => {
      ...
      // TODO CHECK THAT THIS WORKS WITH TARGET
      if (this.queryStringsBuilder) payload.qs = this.queryStringsBuilder(data, target)
  ...
  // TODO ENSURE THIS WORKS WITH THE NEW SYSTEM
