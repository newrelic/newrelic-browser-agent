...
testDriver.test(
  "capturing large payload of XHR ajax events",
...
testDriver.test(
  "Distributed Tracing info is added to XHR ajax events",
  function (t, browser, router) {
    const config = {
      accountID: "1234",
      agentID: "1",
...
testDriver.test(
  "Distributed Tracing info is added to Fetch ajax events",
  fetchBrowsers,
  function (t, browser, router) {
    const config = {
      accountID: "1234",
