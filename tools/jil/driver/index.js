...
wd.addAsyncMethod('waitForFeature', function (feat, cb) {
  this.waitFor(
    ...
    asserters.jsCondition(`window.NREUM && window.NREUM.activatedFeatures && Object.values(window.NREUM.activatedFeatures)[0] && Object.values(window.NREUM.activatedFeatures)[0]['${feat}']`),
