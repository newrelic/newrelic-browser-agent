...
testDriver.test(
  ...
  firstPaint.and(notSafariWithSeleniumBug),
...
testDriver.test(
  "First contentful paint for supported browsers",
  firstContentfulPaint.and(notSafariWithSeleniumBug),
  function (t, browser, router) {
    t.plan(1);
...
testDriver.test(
  "First paint for unsupported browsers",
  firstPaint.inverse().and(notSafariWithSeleniumBug),
  function (t, browser, router) {
    t.plan(1);
...
testDriver.test(
  "First contentful paint for unsupported browsers",
  firstContentfulPaint.inverse().and(notSafariWithSeleniumBug),
  function (t, browser, router) {
    t.plan(1);
...
testDriver.test(
  "route change interactions should not contain paint metrics values",
  firstPaint.intersect(firstContentfulPaint).and(notSafariWithSeleniumBug),
  function (t, browser, router) {
    t.plan(3);
