...
function submissionXhr(type, browserVersionMatcher) {
  testDriver.test(`${type} - capturing XHR metrics`, browserVersionMatcher, function (t, browser, router) {
    let assetURL = router.assetURL(`worker/${type}-worker.html`, {
      init,
      workerCommands: [
        () => {
...
function submissionFetch(type, browserVersionMatcher) {
  testDriver.test(`${type} - capturing fetch metrics`, browserVersionMatcher, function (t, browser, router) {
    let assetURL = router.assetURL(`worker/${type}-worker.html`, {
      init,
