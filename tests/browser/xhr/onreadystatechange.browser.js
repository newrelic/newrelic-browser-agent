...
jil.browserTest(
  "xhr with onreadystatechange assigned after send",
  async function (t) {
    const ffVersion = await import(
      "../../../src/common/browser-version/firefox-version"
    );
      ...
      xhr.onreadystatechange = function (e) {
        if (ffVersion > 10) {
          t.ok(
            ...
            "onreadystatechange should be wrapped for readyState " +
              xhr.readyState
          );
        }
...
jil.browserTest(
  "multiple XHRs with onreadystatechange assigned after send",
  async function (t) {
    const ffVersion = await import(
      "../../../src/common/browser-version/firefox-version"
    );
    ...
    setTimeout(() => {
      ...
      function countDown() {
        ...
        t.ok(
          xhr1.readyStatesSeen.indexOf(2) !== -1,
          "saw readyState 2 for xhr1"
        );
        t.ok(
          xhr1.readyStatesSeen.indexOf(3) !== -1,
          "saw readyState 3 for xhr1"
        );
        t.ok(
          xhr1.readyStatesSeen.indexOf(4) !== -1,
          "saw readyState 4 for xhr1"
        );

        t.ok(
          xhr2.readyStatesSeen.indexOf(2) !== -1,
          "saw readyState 2 for xhr2"
        );
        t.ok(
          xhr2.readyStatesSeen.indexOf(3) !== -1,
          "saw readyState 3 for xhr2"
        );
        t.ok(
          xhr2.readyStatesSeen.indexOf(4) !== -1,
          "saw readyState 4 for xhr2"
        );
