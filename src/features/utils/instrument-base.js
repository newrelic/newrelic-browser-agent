...
export class InstrumentBase extends FeatureBase {
   ...
   */
  constructor (agentIdentifier, featureName, auto = true) {
    super(agentIdentifier, featureName)
    this.auto = auto
  ...
  importAggregator (argsObjFromInstrument = {}) {
    ...
    const importLater = async () => {
      ...
      try {
        ...
        this.featAggregate = new Aggregate(this.agentIdentifier, argsObjFromInstrument)
