...
export class Interaction extends SharedContext {
  constructor(eventName, timestamp, url, routeName, onFinished, parent) {
    super(parent)

    this.ee = ee.get(this.sharedContext.agentIdentifier)
