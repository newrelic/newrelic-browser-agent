...
const instantiateSourceMapPlugin = (filename) => {
  return new webpack.SourceMapDevToolPlugin({
    ...
    filename:
      filename ||
      (SUBVERSION === "PROD" ? `[name].[hash:8].map` : `[name].map`),
...
const commonConfig = {
  ...
  output: {
    ...
    chunkFilename:
      SUBVERSION === "PROD"
        ? `[name].[hash:8]${PATH_VERSION}.js`
        : `[name]${PATH_VERSION}.js`,
...
const standardConfig = merge(commonConfig, {
  entry: {
    [`nr-loader-rum${PATH_VERSION}`]: path.resolve(
      __dirname,
      "./src/cdn/lite.js"
    ),
    [`nr-loader-rum${PATH_VERSION}.min`]: path.resolve(
      __dirname,
      "./src/cdn/lite.js"
    ),
    [`nr-loader-full${PATH_VERSION}`]: path.resolve(
      __dirname,
      "./src/cdn/pro.js"
    ),
    [`nr-loader-full${PATH_VERSION}.min`]: path.resolve(
      __dirname,
      "./src/cdn/pro.js"
    ),
    [`nr-loader-spa${PATH_VERSION}`]: path.resolve(
      __dirname,
      "./src/cdn/spa.js"
    ),
    [`nr-loader-spa${PATH_VERSION}.min`]: path.resolve(
      __dirname,
      "./src/cdn/spa.js"
    ),
  },
...
const polyfillsConfig = merge(commonConfig, {
  entry: {
    [`nr-loader-rum-polyfills${PATH_VERSION}`]: path.resolve(
      __dirname,
      "./src/cdn/polyfills/lite.js"
    ),
    [`nr-loader-rum-polyfills${PATH_VERSION}.min`]: path.resolve(
      __dirname,
      "./src/cdn/polyfills/lite.js"
    ),
    [`nr-loader-full-polyfills${PATH_VERSION}`]: path.resolve(
      __dirname,
      "./src/cdn/polyfills/pro.js"
    ),
    [`nr-loader-full-polyfills${PATH_VERSION}.min`]: path.resolve(
      __dirname,
      "./src/cdn/polyfills/pro.js"
    ),
    [`nr-loader-spa-polyfills${PATH_VERSION}`]: path.resolve(
      __dirname,
      "./src/cdn/polyfills/spa.js"
    ),
    [`nr-loader-spa-polyfills${PATH_VERSION}.min`]: path.resolve(
      __dirname,
      "./src/cdn/polyfills/spa.js"
    ),
    [`nr-loader-spa-polyfills${PATH_VERSION}.min`]: path.resolve(
    ...
    [`nr-polyfills${PATH_VERSION}.min`]: path.resolve(
      __dirname,
  ...
  plugins: [
    ...
    instantiateSourceMapPlugin(
      SUBVERSION === "PROD" ? `[name].[hash:8].map` : `[name]-es5.map`
    ),
  ],
