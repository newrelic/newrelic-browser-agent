...
// 0. Ensure the output directory is available
await fs.promises.mkdir(outputDir, { recursive: true })

// 1. Create latest environment script (dev only - canary build)
...
// 2. Create experiments script (dev only)
